package com.yptake.yplearnproject.widget;
...
public class DragTouchListener implements View.OnTouchListener {
     ...
     * 是否取消：触摸移动
     */
    private boolean isCancelTouchDrag = false;
     ...
     * 设置：是否取消拖拽移动
     *
     * @param cancelTouchDrag
     */
    public DragTouchListener setCancelTouchDrag(boolean cancelTouchDrag) {
        isCancelTouchDrag = cancelTouchDrag;
        return this;
    }
