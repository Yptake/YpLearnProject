package com.yptake.yplearnproject.widget.interfaces;
...
import com.yptake.yplearnproject.widget.VerticalDraggableView;
...
public class VerticalDraggableViewCallback extends ViewDragHelper.Callback {
    ...
    public VerticalDraggableViewCallback(VerticalDraggableView verticalDraggableView) {
        ...
        Y_MIN_DISTANCE = ArmsUtils.getScreenHeidth(verticalDraggableView.getContext())/3;
    }
