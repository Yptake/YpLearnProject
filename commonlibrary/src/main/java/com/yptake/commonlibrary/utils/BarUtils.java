...
public final class BarUtils {
    ...
    public static void setStatusBarLightMode(@NonNull final Activity activity,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            setStatusBarColor(activity, Color.parseColor("#4Dffffff"));
        }
    }
    ...
    public static int getActionBarHeight() {
        ...
        if (ContextUtil.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, ContextUtil.getContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = ContextUtil.getContext()
                        .getResources()
